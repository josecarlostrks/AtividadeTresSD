...
public class Clienteum {
    ...
    public Clienteum() throws IOException{
    ...
    public static void main(String[] args) throws IOException{
        ...
        Clienteum chatCliente = new Clienteum();
...
class Listener implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Clienteum.saida.println(Clienteum.chatNovaMensagem.getText());        
        Clienteum.chatNovaMensagem.setText("");
    }
